...
async function getTeamState(div,team){
  ...
  // Existing live division data becomes Team 1

  // until the first new team-aware save is made.
  ...
  if(
    ...
    q=await pool.query(
      ...
      `select data,updated_at from app_state where id='master'`
